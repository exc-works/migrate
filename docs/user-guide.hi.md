...
- Sources: `DirectorySource` (फ़ाइल सिस्टम), `StringSource` (in-memory slice, टेस्ट के लिए उपयोगी), `CombinedSource` (कई sources को मिलाता है)
...
### 12.5 SQL का पूर्वावलोकन (DryRun)
